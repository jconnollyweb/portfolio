  ...
  const projects = [
    {
      ...
      description: "Following on from my previous Wordpress Project I have built a small Book Festival Website theme to build on my knowledge of custom themes and post types. It was built  using PHP, HTML, CSS and JavaScript.  ",
      image: bookImage,
